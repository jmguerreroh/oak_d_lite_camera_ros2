...
def generate_launch_description():
    ...
    metric_converter_node = launch_ros.actions.ComposableNodeContainer(
            name='metric_converter_container',
            namespace='',
    ...
    point_cloud_color_node = launch_ros.actions.ComposableNodeContainer(
            name='pcl_color_container',
            namespace='',
            package='rclcpp_components',
            executable='component_container',
            composable_node_descriptions=[
    ...
    ld.add_action(point_cloud_color_node)
